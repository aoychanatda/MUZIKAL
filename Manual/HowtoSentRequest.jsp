<%-- 
    Document   : HowtoSentRequest
    Created on : Apr 21, 2017, 6:04:23 PM
    Author     : lenovo
--%>
...
<html lang="en" class="no-js"> 
  <head>
    ...
    <title>How to Sent Request Concert</title>
    ...
    <div class="container" id="buy">
                <div class="row" style="width: 70%; margin: 0 auto">
                    <div class="col-xs-12">        
                        <div class="thumbnail">
                            <center><h3>วิธีการส่งข้อมูลคอนเสิร์ต</h3></center>
                            <hr size="10" width="100%">
                            <p> ก่อนที่จะทำการขายบัตรคอนเสิร์ตได้นั้น ทางผู้จัดจะต้องทำการส่งข้อมูลคอนเสิร์ตไปให้กับทางผู้ดูแลระบบก่อน<br>
                            แล้วให้ผู้ดูแลระบบนั้นยอมรับคำร้องขอของผู้จัด จึงจะสามารถทำการขายบัตรคอนเสิร์ตนั้นได้<br></p>
                              
                           
                            สำหรับขั้นตอนการส่งข้อมูลคอนเสิร์ตมีขั้นตอน ดังนี้<br>
                            1.เข้าสู่ระบบด้วยชื่อบัญชีของคุณ<br>
                            2. คลิกที่ชื่อบัญชีของคุณ ตรงมุมขวาบนของหน้าจอ เลือกเมนู ‘My DashBoard’ <br>
                            <center>ใส่รูป</center><br>
                            3.  คลิกที่ปุ่ม Forms<br>
                            <center>ใส่รูป</center><br>
                            4. ทำการกรอกข้อมูลตามformทั้งหมด<br>
                            <center>ใส่รูป</center><br>
                            5.กดปุ่ม ‘Send Request’ เพื่อส่งข้อมูลคอนเสิร์ต<br>
