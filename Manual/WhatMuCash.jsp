    ...
    <body class="colorful3">   
            ...
            <div class="container" id="buy">
                <div class="row" style="width: 70%; margin: 0 auto">
                    <div class="col-xs-12">        
                        <div class="thumbnail">
                            <center><h3>เมนู ‘Mu Cash’ คืออะไร ?</h3></center> 
                            <hr size="10" width="100%"><br>
                            <p>เมนู ‘Mu Cash’ เป็นเหมือนกระเป๋าที่เก็บข้อมูลรายการคำสั่งซื้อและบัตรที่คุณเคยทำรายการไว้ทั้งหมด<br>
                               คุณสามารถเช็คข้อมูลต่างๆ ของคุณได้ดังนี้<br>
                               1.Mu Cash รายการคำสั่งซื้อจะแสดงเลขที่คำสั่งซื้อ, อีเว้นท์, ราคา, สถานะ และการจัดส่ง<br>
