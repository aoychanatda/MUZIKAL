<%-- 
    Document   : WhatTicketRefund
    Created on : Apr 20, 2017, 2:33:13 PM
    Author     : admin
--%>
    ...
    <body class="colorful3">   
            ...
            <div class="container" id="buy">
                <div class="row" style="width: 70%; margin: 0 auto">
                    <div class="col-xs-12">        
                        <div class="thumbnail">
                            <center><h3>‘Ticket Refund’ คืออะไร ?</h3></center>
                            <hr size="10" width="100%">
                            <p>
                                เป็นบริการเสริมในกรณีลูกค้าเกิดเหตุสุดวิสัยไม่สามารถไปชมการแสดงในวันจริงได้ 
                                โดยจะต้องทำการซื้อบริการ Ticket Refund โดยมีค่าบริการเพิ่มเติม
                                เลือกใช้บริการโดยทำการกดใช้ Ticket Refund
                                <center>ใส่รูปเหวย!!!!!</center><br><br>
                                
                                <center><h3>วิธีการขอคืนเงิน</h3></center>
                                <hr size="10" width="100%">
                            1. เข้าสู่ระบบด้วยชื่อบัญชีที่ต้องการขอคืนเงิน <br>
                            2. คลิกที่ชื่อบัญชีของคุณ ตรงมุมขวาบนของหน้าจอ เลือกเมนู ‘My Ticket’ <br>
                            <center>ใส่รูปเหวย!!!!!</center><br>
                            3. เลือกเมนู Ticket Refund<br>
                            4. กดปุ่ม ‘Get a Refund’ เลือก concert ที่ต้องการรับเงินคืน<br>
                            <center>ใส่รูปเหวย!!!!!</center><br>
                            5. กดเลือก accept เพื่อยอมรีบเงื่อนไขการใช้บริการ Ticket refund
                            <center>ใส่รูปเหวย!!!!!</center><br>
                            6. กด Confirm เพื่อยืนยันการใช้ระบบคืนเงิน
                            <center>ใส่รูปเหวย!!!!!</center><br>
                            7. วงเงินที่ Mu Cash จะเพิ่มขึ้น
                            <center>ใส่รูปเหวย!!!!!</center><br>
