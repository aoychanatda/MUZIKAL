<%-- 
    Document   : HowtoSignIO_AD
    Created on : Apr 20, 2017, 9:06:53 PM
    Author     : admin
--%>
                ...
                <div class="row" style="width: 70%; margin: 0 auto">
                    <div class="col-xs-12">        
                        <div class="thumbnail">
                            ...
                            <center><h3>วิธีออกจากระบบ</h3></center>
                            <hr size="10" width="100%">
                            <p>
                               1.คลิกปุ่มทางด้านบนขวามือแล้วเลือก Sign out จะทำการออกสู่ระบบ
                               <center>ใส่รูปเหวย!!!!!</center><br><br>
                            </p>
                        </div>
                    </div>
