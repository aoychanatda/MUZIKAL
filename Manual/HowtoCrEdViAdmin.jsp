<%-- 
    Document   : HowtoCrEdViAdmin
    Created on : Apr 21, 2017, 5:04:34 PM
    Author     : admin
--%>
    ...
    <body class="colorful3">   
            ...
            <div class="container" id="buy">
                <div class="row" style="width: 70%; margin: 0 auto">
                    <div class="col-xs-12">        
                        <div class="thumbnail">
                            <center><h3>วิธีสร้างบทความสำหรับผู้ดูแลระบบ</h3></center>
                            <hr size="10" width="100%">
                            ขั้นตอนการสร้างบทความ มีดังนี้<br>
                            1. เลือก ‘Create Article’ เพื่อทำการสร้างบทความคอนเสิร์ต<br>
                            <center>ใส่รูปเหวย!!!!!</center><br>
                            
                            <center><h3>วิธีการแก้ไขข้อมูลคอนเสิร์ตสำหรับผู้ดูแลระบบ</h3></center>
                            <hr size="10" width="100%">
                            ขั้นตอนการแก้ไขบทความ มีดังนี้<br>
                            1. เลือก ‘All Article’<br>
                            1. เลือก Edit คอนเสิร์ตที่ต้องการจะแก้ไขข้อมูล<br>
                            <center>ใส่รูปเหวย!!!!!</center><br>
                            
                            <center><h3>วิธีดูบทความสำหรับผู้ดูแลระบบ</h3></center>
                            <hr size="10" width="100%">
                            ขั้นตอนการดูบทความ มีดังนี้<br>
                            1. เลือก ‘View Article’ เพื่อดูบทความคอนเสิร์ตที่ได้เขียนไว้<br>
                            <center>ใส่รูปเหวย!!!!!</center><br>
