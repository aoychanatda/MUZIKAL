...
public class Order {
    ...
    public void UpdateGetRefund(String change, String Login_ID, String Order_ID) {
        try {
            Statement stmt = con.createStatement();
            String sql2 = "Update Reservation set getRefund='" + change + "' where User_ID='" + Login_ID + "' AND Order_ID='" + Order_ID + "';";
