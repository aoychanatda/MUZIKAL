    ...
    <body class="colorful3">   
            ...
            <div class="container" id="buy">
                <div class="row" style="width: 70%; margin: 0 auto">
                    <div class="col-xs-12">        
                        <div class="thumbnail">
                            <center><h3>‘My Ticket’ คืออะไร ?</h3></center>
                            <hr size="10" width="100%">
                            <p>
                                เมนู ‘My Ticket’ เป็นเมนูที่เก็บข้อมูลรายการคำสั่งซื้อและบัตรที่คุณเคยทำรายการไว้ทั้งหมด 
                                คุณสามารถเช็คข้อมูลต่างๆ ของคุณได้ดังนี้
                                1. History แสดงประวัติการสั่งซื้อทั้งหมดของคุณที่คุณเคยได้ทำการสั่งซื้อไว้
                                <center>ใส่รูปเหวย!!!!!</center><br><br>
                                2. E-Ticket เป็นบัตรเข้าคอนเสิร์ตอิเล็กทรอนิกส์เพื่อใช้ในเข้าดูคอนเสิร์ตนั้นๆได้ โดย E-Ticket
                                จะได้เมื่อคุณทำการชำระเงินค่าจองบัตรเรียบร้อยแล้ว
                                <center>ใส่รูปเหวย!!!!!</center><br><br>
                                3. Mu Cash แสดงยอดเงินปัจจุบันของคุณ
                                <center>ใส่รูปเหวย!!!!!</center><br><br>
                                4. Ticket Refund แสดงคอนเสิร์ตที่คุณได้ทำการเลือกใช้บริการ Ticket Reffund และสามารถ
                                เลือกคอนเสิร์ตที่ต้องการขอคืนเงิน
                                <center>ใส่รูปเหวย!!!!!</center><br><br>
                            </p>
                        </div>
                    </div>
