        ...
        <div id="wrapper2">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <form name="RequestConcertServlet" method="post" action="RequestConcertServlet" enctype="multipart/form-data">
                        <div id="concert-request-form">
                            ...
                            <div id="Cover" class="form-group">
                                ...
                                <input href="/img/image-name.jpg" download  type="file" id="exampleInputFile" name="CoverImage">
                            ...
                            <div id="Poster" class="form-group">
                                ...
                                <input type="file" id="exampleInputFile" name="BrowsePoster">
