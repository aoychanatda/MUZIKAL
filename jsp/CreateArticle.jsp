        ...
        <div id="page-wrapper">
            ...
            <form name="summernoteServlet" method="post" action="summernoteServlet"  id="myForm">
                <div class="container-fluid">
                        ...
                        <div class="row"> 
                            <div class="col-sm-4">
                                <select class="form-control" name="Concert_ID">
                                    <option value="-1">Select Concert</option>
                    ...
                    <p class="help-block">Get map code from: https://www.google.co.th/maps</p>
                    ...
                    <div class=".col-md-3 .col-md-offset-3 text-right">
                        <input class="btn btn-success" id="confirm" type="submit" name="btn" value="Publish"/>
                    </div>
