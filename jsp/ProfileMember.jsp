<%-- 
    Document   : Profile
    Created on : Apr 15, 2017, 10:21:55 AM
    Author     : lenovo
--%>
...
<html lang="en">
    ...
    <body class="colorful3">
        ...
        <sql:query var = "user" dataSource="${it58070053_webp}">
            select Member.User_ID, User.Fname , User.Lname , User.Email , Member.Phone_Number , Member.Birth_Date , Member.Address , Member.IDcard , Member.Gender from User JOIN Member Using (User_ID) Where User_ID = ?;
