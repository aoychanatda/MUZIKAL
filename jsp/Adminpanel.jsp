<%-- 
    Document   : Adminpanel
    Created on : Apr 18, 2017, 1:30:57 PM
    Author     : test
--%>
        ...
        <div id="wrapper2">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <body class="colorful3">
                    ...
                    <sql:query var="user" dataSource="${it58070053_webp}">
                        select Article.Article_ID , User.User_ID, User.Fname, User.Lname, Article.Date_Time , Article.Article_Name , Article.Content , Article.Map from User JOIN Article Using (User_ID) Where User_ID = ?;
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class=".col-md-3 .col-md-offset-3 text-right"><a class="btn btn-info" href="CreateArticle.jsp">+ Create Article</a></div>
                        ...
                        <tbody>
                            <c:forEach var="row" items="${user.rows}">
                                <tr>
                                    ...
                                    <td>${row.Date_Time}</td>
                                    <td>
                                            <a class="btn btn-default" href="EditArticle.jsp?id=${row.Article_ID}" name="Edit" value="editform" >Edit</a>
                                            <a class="btn btn-success" href="Artical.html" >View Article</a>
