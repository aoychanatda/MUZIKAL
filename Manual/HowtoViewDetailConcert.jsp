  ...
  <head>
    ...
    <div class="container" id="buy">
                <div class="row" style="width: 70%; margin: 0 auto">
                    <div class="col-xs-12">        
                        <div class="thumbnail">
                            <center><h3>วิธีการดูข้อมูลคอนเสิร์ต</h3></center>
                            <hr size="10" width="100%">

                            สำหรับขั้นตอนการดูข้อมูลคอนเสิร์ตมีขั้นตอน ดังนี้<br>
                            1.เข้าสู่ระบบด้วยชื่อบัญชีของคุณ<br>
                            2.เมื่อเข้าสู่ระบบแล้วจะเข้าสู่หน้าแรก ซึ่งในหน้าแรกนั้นจะโชว์คอนเสิร์ตต่างๆ<br>
                            <center>ใส่รูป</center><br>
                            3. ให้คลิกที่ปุ่ม View ของคอนเสิร์ตนั้นๆถ้าหากคุณต้องการจะดูข้อมูลคอนเสิร์ตของแต่ละคอนเสิร์ต<br>
                            <center>ใส่รูป</center><br>
