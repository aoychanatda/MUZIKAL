<%-- 
    ...
    Created on : Apr 16, 2017, 9:44:39 AM
    Author     : lenovo
--%>
...
<html lang="en">
    ...
    <body class="colorful3">
        ...
        <sql:query var = "user" dataSource="${it58070053_webp}">
            select Admin.User_ID, User.Fname , User.Lname , User.Email from User JOIN Admin Using (User_ID) Where User_ID = ?;
            ...
            <div class="row">
                <div class="container ">
                    <div class="col-lg-3 col-md-6" style="padding: 85px 0; text-align:center;">
                        <a href="WhatAd.html" style="text-decoration: none"><h3><font color="white">What is Muzikal</font></h3></a>
                    </div>
