<%-- 
    Document   : HowToPay
    Created on : Apr 20, 2017, 2:35:19 PM
    Author     : admin
--%>
    ...
    <body class="colorful3">   
            ...
            <div class="container" id="buy">
                <div class="row" style="width: 70%; margin: 0 auto">
                    <div class="col-xs-12">        
                        <div class="thumbnail">
                            <center><h3>การชำระเงินผ่านบัตรเครดิต</h3></center>
                            <hr size="10" width="100%">
                            <p>
                              เบื้องต้นทาง Muzikal รองรับการชำระเงินผ่านบัตรเครดิตของ VISA/Mastercard/JCB และรองรับการชำระเงินผ่านบัตรเดบิตของ 
                              ธนาคารกรุงเทพ/ธนาคารกรุงไทย/ธนาคารกสิกร/ไทยพาณิชย์ <br>
                              ในส่วนของการกรอกข้อมูลบัตรเพื่อชำระเงิน จะต้องกรอกข้อมูลให้ครบ ดังนี้<br>
                              <center>ใส่รูปเหวย!!!!!</center><br><br>
                              - หมายเลขบัตรเครดิต/บัตรเดบิต หมายเลขจะอยู่บนหน้าบัตรเครดิต/บัตรเดบิต ของท่าน<br>
                              - ชื่อผู้ถือบัตร <br>
                            ...
                            <hr size="10" width="100%">
                            <p>
                                1. เลือกการชำระเงินผ่านบิล<br>
                                2. ยืนยันการชำระเงิน<br>
                            </p>
                        </div>
                    </div>
                </div>
