    ...
    <div class="container" style="width: 100%;">
        <div class="row" style="width: 100%; margin-left:-3%;">
            <ul class="grid cs-style-2">                
                ...
                <c:forEach var="row" begin="0" end= "3" step="1" items="${concert.rows}">
                
                    <div class="col-sm-4 col-xs-12">
                        <li>
                            <figure>
                                
                                <img src="img/concert1.jpg" alt="img02">
                                <figcaption>
                                    <h4>${row.Concert_Name}</h4>                                        
                                    <h6>${row.Start_Date}</h6>
                                    
                                    <a href="Article.jsp" name="test">View Detail!</a>
                                    <input type="submit" value="View Detail" name="test" class="btn btn-danger" />
                                </figcaption>
                            </figure>
                        </li>
                    </div>
    ...
    <footer style="background-color: rgba(0,0,0,0.6);">
        <div class="container ">
            <div class="col-lg-3 col-md-6" style="padding: 85px 0; text-align:center;">
                <a href="WhatMuzikal.jsp" style="text-decoration: none"><h3><font color="white">What is Muzikal</font></h3></a>
            </div>
